 ...
 * @author fatiq
 */
public class PilihSupplier extends javax.swing.JDialog {
    ...
    public Supplier mod = new Supplier();
    
    public PilihSupplier(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PilihSupplier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PilihSupplier dialog = new PilihSupplier(new javax.swing.JFrame(), true);
