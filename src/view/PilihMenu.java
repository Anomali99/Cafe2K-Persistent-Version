...
import tabel.TabelMenu;

/**
 *
 * @author fatiq
 */
public class PilihMenu extends javax.swing.JDialog {

    /**
     * Creates new form TambahPelanggan
     */
    int xx, xy;
    private final TabelMenu tbl = new TabelMenu();
    private ServisMenu servis = new DaoMenu();
    public Menu mod = new Menu();
    
    public PilihMenu(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        cbx_cari.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "KODE", "NAMA", "BAHAN" }));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PilihMenu dialog = new PilihMenu(new javax.swing.JFrame(), true);
