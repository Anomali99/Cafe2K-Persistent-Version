...
public class TambahMenu extends javax.swing.JDialog {
    ...
    public TambahMenu(java.awt.Frame parent, boolean modal, String id) {
        ...
        for (DetailBahan db : mod.getDetailBahanCollection()) {
            Object[] ob = new Object[3];
            ob[0] = db.getBahan().getKodeBahan();
            ob[1] = db.getBahan().getNama();
            ob[2] = db.getJumlah();
            tbl.addRow(ob);
        }
    ...
    private void initComponents() {
        ...
        tfJmlBahan.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                tfJmlBahanFocusGained(evt);
            }
            public void focusLost(java.awt.event.FocusEvent evt) {
                tfJmlBahanFocusLost(evt);
            }
        });
    ...
    private void btnSimpanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSimpanMouseClicked
        if (validData()) {
            ...
            List<DetailBahan> bahan = new ArrayList();
            DefaultTableModel tbl = (DefaultTableModel) tblBahan.getModel();
            int index = tbl.getRowCount() - 1;
            for (int i = 0; i <= index; i++) {
                DetailBahan bn = new DetailBahan();
                DetailBahanPK pk = new DetailBahanPK();
                pk.setKodeBahan(tbl.getValueAt(i, 0).toString());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        dj.setVisible(true);
        try {
            tfKodeBahan.setText(dj.mod.getKodeBahan());
    ...
    private void tfJmlBahanFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tfJmlBahanFocusGained
        if(tfJmlBahan.getText().equals("0"))
            tfJmlBahan.setText("");
    }//GEN-LAST:event_tfJmlBahanFocusGained

    private void tfJmlBahanFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tfJmlBahanFocusLost
        if(tfJmlBahan.getText().equals(""))
            tfJmlBahan.setText("0");
    }//GEN-LAST:event_tfJmlBahanFocusLost
