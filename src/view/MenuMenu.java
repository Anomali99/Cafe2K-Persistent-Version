...
public class MenuMenu extends javax.swing.JPanel {
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        if (!btnHapus.isVisible()) {
            new TambahMenu(null, true).setVisible(true);
        } else {
            String s = (String) tblConten.getValueAt(tblConten.getSelectedRow(), 1);
            new TambahMenu(null, true, s).setVisible(true);
        }
        resetData();
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(null, "Menghapus menu dengan Kode " + s, "Apakah anda yakin", 0, 0, icon) == 0) {
            servis.hapusData(s);
        }
        resetData();
