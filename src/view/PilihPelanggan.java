...
public class PilihPelanggan extends javax.swing.JDialog {
    ...
    public Pelanggan mod = new Pelanggan();
    
    public PilihPelanggan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PilihPelanggan dialog = new PilihPelanggan(new javax.swing.JFrame(), true);
