...
import servis.ServisEmail;

/**
 *
 * @author fatiq
 */
public class DaoEmail implements ServisEmail {
    ...
    @Override
    public void kririm(String email, String subyek, JasperPrint print) {
        try {
            ...
            attachment.setFileName(subyek + ".pdf");
