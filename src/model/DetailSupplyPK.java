 ...
 */
@Embeddable
public class DetailSupplyPK implements Serializable {
    ...
    public DetailSupplyPK() {
    }

    public DetailSupplyPK(String kodeBahan, String idSupplier, String idPegawai, String noSupply) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DetailSupplyPK)) {
            return false;
        }
        DetailSupplyPK other = (DetailSupplyPK) object;
    ...
    public String toString() {
        return "model.DetailSupplyPK[ kodeBahan=" + kodeBahan + ", idSupplier=" + idSupplier + ", idPegawai=" + idPegawai + ", noSupply=" + noSupply + " ]";
    }
